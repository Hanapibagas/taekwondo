...
@section('title', 'Pengajuan Tingkat')
...
<div class="page-heading">
  ...
  <section class="section">
    <div class="card">
      <div class="card-body">
        {{-- <button class="btn btn-success mb-4" data-toggle="modal" id="button-tambah"><i class="mdi mdi-plus-circle"></i> Tambah</button> --}}
          ...
          <table class="table table-bordered" id="table-data" style="width:100%">
            <thead>
              <tr>
                ...
                <th>Nama</th>
                <th>Kab/Kota</th>
                <th>Sabuk saat ini</th>
                <th>Sabuk yang diusulkan</th>
                {{-- <th>Status</th> --}}
                <th>Action</th>
              </tr>
            </thead>
...
{{-- @include('dashboard.admin.naik-tingkat.modal') --}}
...
<script type="text/javascript">
  ...
  $('#button-tambah').click(function() {
    ...
    $('#title').html("Tambah Pengajuan"); //valuenya tambah role baru
  ...
  //   $.get('edit-naik-tingkat/' + data_id, function(data) {
  //     $('#tambah-edit-modal').modal('show');
  //     $('#title').html("Edit Pengajuan "); //valuenya tambah role baru
  ...
  $('body').on('click', '.edit-data', function() {
    ...
    Swal.fire({
      icon: 'info'
      , title: 'Terima? '
      , text: 'Anda yakin ingin Terima data ini?'
      , type: 'info'
