...
@include('dashboard.admin.agenda.modal')
...
<script>
  ...
  $('#button-tambah').click(function() {
    ...
    $('#title').html("Tambah Agenda"); //valuenya tambah role baru
  ...
  $('body').on('click', '.edit-data', function() {
    ...
    $.get('edit-agenda/' + data_id, function(data) {
      $('#tambah-edit-modal').modal('show');
      $('#title').html("Edit Agenda "); //valuenya tambah role baru
