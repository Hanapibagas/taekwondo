            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  <label for="exampleInputUsername1">Agenda:</label>
                  <input type="text" class="form-control" name="agenda" id="agenda" placeholder="Masukkan Agenda">
                </div>

                <div class="form-group">
                  <label for="exampleInputUsername1">Lampiran:</label>
                  <input type="file" class="form-control" name="file" id="file" placeholder="Lampiran">
