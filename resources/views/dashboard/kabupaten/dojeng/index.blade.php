...
@include('dashboard.kabupaten.dojeng.modal')
...
<script type="text/javascript">
  ...
  $('body').on('click', '.edit-data', function() {
    ...
    $.get('edit-dojeng/' + data_id, function(data) {
