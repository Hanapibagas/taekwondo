...
@push('link')
    <meta property="og:image" itemprop="image" content="{{ asset('storage') }}/images/berita/{{ $detail->image }}">
...
@section('content')
<div class="page-title-area " style="padding-bottom:0px">
  <div class="container">
...
<section class="blog-details mt-2">
  <div class="container">
