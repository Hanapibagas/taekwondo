...
@push('style')
<link rel="stylesheet" href="{{ asset('portal/assets/css/lightbox.min.css') }}">
@endpush
    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-md-6 col-sm-6">
        <div class="single-projects-box">
          <a class="example-image-link" href="{{ asset('storage/gallery/images/' . $img->images) }}" data-lightbox="example-set" data-title="Click the right half of the image to move forward.">
            <img class="example-image" src="{{ asset('storage/gallery/images/' . $img->images) }}" alt="image" style="width: 356px; height: 286px;" />
          </a>
        </div>
      </div>
      @endforeach
...
@push('script')
<script src="{{ asset('portal/assets/js/lightbox-plus-jquery.min.js') }}"></script>
@endpush
