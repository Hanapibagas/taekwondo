...
<div class="page-title-area">
    <div class="container">
        <div class="page-title-content">
            <h2>Pendaftaran Calon Pelatih</h2>
            <ul>
                <li><a href="/">Home</a></li>
                <li>Pendaftaran Calon Pelatih</li>
            </ul>
        </div>
    </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="ree-blog-details">
                            <form action="{{ route('pelatih.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="nama">Pilih Sabuk<i class="text-danger"
                                            style="font-size: 14px;">*</i></label>
                                    ...
                                    @if($errors->has('sabuk'))
                                    <span class="form-text text-muted text-danger">{{ $errors->first('sabuk') }}</span>
                                    @endif
                                </div><br>
                                <div class="form-group">
                                    <label for="nama">Pilih Dojeng<i class="text-danger"
                                            style="font-size: 14px;">*</i></label>
                                    <select name="dojeng" class="form-control">
                                        <option value="">-- Pilih Sabuk --</option>
                                        @foreach ($dojang as $item )
                                        <option value="{{ $item->id }}">{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                    @if($errors->has('dojeng'))
                                    <span class="form-text text-muted text-danger">{{ $errors->first('dojeng') }}</span>
                                    @endif
                                </div><br>
                                <div class="form-group">
                                    <label for="nama">Pilih Kab/Kota<i class="text-danger"
                                            style="font-size: 14px;">*</i></label>
                                    <select name="regency" class="form-control" id="regency">
                                        ...
                                        <option value="{{ $item->id }}">{{ $item->name }}</option>
                                        @endforeach
                                    </select @if($errors->has('regency'))
                                    <span class="form-text text-muted text-danger">{{ $errors->first('regency')
                                        }}</span>
                                    @endif
                                </div><br>
                                <div class="form-group">
